...
// -----------------------------------------------
void switchLead(String lead) {
  if (lead == "DI") {
    digitalWrite(MUX_A, LOW);
    digitalWrite(MUX_B, LOW);
    Serial.println("Derivacion cambiada a DI");
  } else if (lead == "DII") {
    digitalWrite(MUX_A, HIGH);
    digitalWrite(MUX_B, LOW);
    Serial.println("Derivacion cambiada a DII");
  } else if (lead == "DIII") {
    digitalWrite(MUX_A, LOW);
    digitalWrite(MUX_B, HIGH);
    Serial.println("Derivacion cambiada a DIII");
  } else if (lead == "AVR") {
    digitalWrite(MUX_A, HIGH);
    digitalWrite(MUX_B, HIGH);
    Serial.println("Derivacion cambiada a aVR");
  }
}
...
void loop() {
   ...
   if (Serial.available()) {
     ...
     if (command.startsWith("LEAD_")) {
       String lead = command.substring(5);
       switchLead(lead);
     }
   }
